...
#define REACH_HALT_POSE_VEL    1.0  // Maximum velocity to use in reaching the halt pose (Units: rad/s) | 0.5
#define REACH_HALT_POSE_ACC    1.5  // Acceleration to use in reaching the halt pose (Units: rad/s^2) | 1.0
...
Gait::Gait()
 ...
 , m_plotData(CONFIG_PARAM_PATH + "plotData", true)
