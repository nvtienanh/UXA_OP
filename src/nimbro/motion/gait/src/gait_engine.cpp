...
// Defines
#define DEFAULT_HALT_EFFORT_ARMS  0.5 // Default joint effort to use in the halt pose for all the arm joints
#define DEFAULT_HALT_EFFORT_LEGS  0.8 // Default joint effort to use in the halt pose for all the leg joints
